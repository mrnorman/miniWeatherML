...
namespace weno {
  ...
  template <> struct WenoLimiter<3> {
    ...
    YAKL_INLINE void compute_limited_coefs( real s0, real s1, real s2, SArray<real,1,3> &coefs_3 ) const {
      coefs3_shift2( coefs_3 , s(0) , s(1) , s(2) );
      ...
      if (w_1 <= cutoff) w_1 = 0;
      convexify( w_1 , w_3  );
      coefs_3(0) = coefs_3(0)*w_3 + s(1)*w_1;
  ...
  template <> struct WenoLimiter<5> {
    ...
    YAKL_INLINE void compute_limited_coefs( real s0, real s1, real s2, real s3, real s4 , SArray<real,1,5> &coefs_5 ) const {
      ...
      weno3.compute_limited_coefs( s(1) , s(2) , s(3) , coefs_3 );
      coefs5_shift3( coefs_5 , s(0) , s(1) , s(2) , s(3) , s(4) );
  ...
  template <> struct WenoLimiter<7> {
    ...
    YAKL_INLINE void compute_limited_coefs( real s0, real s1, real s2, real s3, real s4, real s5, real s6 ,
      ...
      weno5.compute_limited_coefs( s(1) , s(2) , s(3) , s(4) , s(5) , coefs_5);
      ...
      if (w_5 <= cutoff) w_5 = 0;
      convexify( w_5 , w_7 );
      coefs_7(0) = coefs_7(0)*w_H + coefs_5(0)*w_5;
      coefs_7(1) = coefs_7(1)*w_H + coefs_5(1)*w_5;
      coefs_7(2) = coefs_7(2)*w_H + coefs_5(2)*w_5;
      coefs_7(3) = coefs_7(3)*w_H + coefs_5(3)*w_5;
      coefs_7(4) = coefs_7(4)*w_H + coefs_5(4)*w_5;
      coefs_7(5) = coefs_7(5)*w_H;
      coefs_7(6) = coefs_7(6)*w_H;
    }
  };
  ...
  template <> struct WenoLimiter<9> {
    ...
    YAKL_INLINE void compute_limited_coefs(real s0, real s1, real s2, real s3, real s4, real s5, real s6, real s7, real s8,
      ...
      weno7.compute_limited_coefs( s(1) , s(2) , s(3) , s(4) , s(5) , s(6) , s(7) , coefs_7 );
